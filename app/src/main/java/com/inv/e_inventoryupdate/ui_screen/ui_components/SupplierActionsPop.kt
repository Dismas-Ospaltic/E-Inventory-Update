...
fun SupplierActionsPop(
    ...
    var showSupplierEditDialog by remember { mutableStateOf(false) }
    ...
    Dialog(onDismissRequest = { onDismiss() }) {
        Surface(
            ...
            Column(
                ...
                Text(text = "Manage Supplier", fontWeight = FontWeight.Bold, fontSize = 18.sp)
...
//                            showReturnDialog = true
    ...
    if (showSupplierEditDialog) {
        EditSupplierPop(
            onDismiss = {  showSupplierEditDialog = false ;
                onDismiss()},
